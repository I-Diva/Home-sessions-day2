(function() {
  ...
  describe("words()", function() {
    ...
    it("counts tabs", function() {
      var expectedCounts = { hello: 1, world: 1 };
      expect(myApp.wordCount("hello\tworld")).to.eql(expectedCounts);
    });
    ...
    it("handles properties that exist on Object’s prototype", function() {
      ...
      expect(myApp.wordCount("reserved words like prototype and toString ok?")).to.eql(expectedCounts);
    });
  });
})();
